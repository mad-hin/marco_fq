...
static int marco_fq_parse_opt(const struct qdisc_util *qu, int argc, char **argv,
...
static int marco_fq_print_opt(const struct qdisc_util *qu, FILE *f, struct rtattr *opt)
{
...
static int marco_fq_print_xstats(const struct qdisc_util *qu, FILE *f,
...
struct qdisc_util marco_fq_qdisc_util = {
    .id = "marco_fq",
    .parse_qopt = marco_fq_parse_opt,
    .print_qopt = marco_fq_print_opt,
    .print_xstats = marco_fq_print_xstats,
};
